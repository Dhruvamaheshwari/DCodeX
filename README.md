...
- **Test Case Validation System:**
  ...
  - _Passed test cases_ are highlighted in **green**.
  - _Failed test cases_ are highlighted in **red**.
...
- **User Profile & Analytics Dashboard:**
  - **GitHub-Style Heatmap:** Interactive, color-coded daily submission calendar showing 1-year historic solved data.
  - **Streak Tracking:** Real-time calculation of Current and Max coding streaks.
  - **Submission History:** Tabular layout mapping solved problems, accepted languages, and difficulties.
  - **Account Settings:** Allows users to easily update display names and change passwords.
...
![Problem List](public/problem-list.png)

### Code Editor & Live Execution

![Code Editor Interface](public/code-editor.png)

### Submission Tracking

#### Submissions List

![Submissions List](public/submissions-list.png)

#### Detailed Submission Results

![Submission Detail](public/submission-detail.png)

### User Profile & Analytics

#### Profile Overview & Heatmap

![User Profile Overview](public/profile-overview.png)
...
- **react-calendar-heatmap & date-fns:** Generating GitHub-style interactive submission heatmaps.
...
```json
{
  ...
  "startCode": [{ "language": "cpp", "initialCode": "int main() { ... }" }],
